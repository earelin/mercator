...
/**
 * Tuning for the polite BOE HTTP layer (ADR-0018). A plain value object &mdash; the {@code server}
 * binds it from Micronaut config and the {@code ingester} from CLI flags; {@code shared} stays
 * framework-free.
 *
