package net.earelin.mercator.shared.infrastructure.persistence;
 ...
 *
 * <p>Depends only on a JDK-standard {@link DataSource}, keeping {@code shared} framework-agnostic
 * (ADR-0014): the server injects its Micronaut/Hikari datasource and the offline ingester supplies
 * its own, so both write paths record through the same adapter.
 *
